...
CONFIG_PATHS = {
    ...
    'slowfast_resnet50': os.path.join(CONFIG_ROOT, 'slowfast_4x16_resnet50_kinetics400.yaml'),
    'slowfast_resnet101': os.path.join(CONFIG_ROOT, 'slowfast_16x8_resnet101_kinetics400.yaml'),
    'tpn_resnet50': os.path.join(CONFIG_ROOT, 'tpn_resnet50_f8s8_kinetics400.yaml'),
    'tpn_resnet101': os.path.join(CONFIG_ROOT, 'tpn_resnet101_f32s2_kinetics400.yaml')
    }

# save info
OPT_PATH = '/data/pch/work1/TT-master/outlog/' # output path

# ucf model infos
UCF_MODEL_ROOT = '/data/pch/work1/TT-master/checkpoints/' # ckpt file path of UCF101
MODEL_TO_CKPTS = {
...
# ucf dataset
UCF_DATA_ROOT = '/data/UCF101/frames/' # ucf101 dataset path
